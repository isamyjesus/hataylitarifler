...
<link href="layout/styles/layout.css" rel="stylesheet" type="text/css" media="all">
    <style type="text/css">
        ...
        .hakkimizda {font-size:16px; margin-left:4%; margin-top:10px;}
    </style>
</head>
<body id="top">
<!-- ################################################################################################ --> 
          ...
          <ul class="nospace listing">
            <li class="clear"> 
              <div class="hakkimizda">
                  ...
                  Inteligula congue id elis donec sce sagittis intes id laoreet aenean. Massawisi condisse quis dui fauctor et donecnibh elis.
              </div>
            </li> 
          </ul>
          <p class="right"></p>
